...
Language native implementations of [ExifTool](https://exiftool.org/)'s `ImageDataHash` for JavaScript,
Python, Rust, R and PHP. Following ExifTool's default behaviour the hashing algorithm is MD5 with the option for SHA-256 or SHA-512.
